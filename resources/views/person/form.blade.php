...
@section('content')
    ...
    <center>
        <div id="formGenre">
            ...
            @endif
                <div class="col25">
                    <img id="posterFormImg" src="{{isset($data) && $data->photo!=null ? url('/img/people/'.$data->photo) : url('/img/uploadPoster.png')}}" onclick="$('#browsePoster').trigger('click')">
                    
                    <div class="groupField" style="display:none">    
                        <input type="file" name="photo" accept=".png, .jpg, .jpeg" id="browsePoster">
                    </div>
                </div>
